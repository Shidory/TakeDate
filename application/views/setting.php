...
<body id="materialize-shopify-themes" class="template-index white">
    <div id="shopify-section-header" class="shopify-section">
        ...
        <div class="row center">
            ...
            <div class="card"
                style="background-image : url('apps.64902.9007199266242800.856b3755-5c57-4455-8c4a-1c980462c57b.821d4cb6-9593-4c09-a396-9c9e9fddc466.jpg');"
                id="semaine">
                <div class="card-content center" id="p">
                    <a class="btn-floating waves-effect waves-light red right modal-trigger" href="#trade-info"><i class="material-icons">edit</i></a>
