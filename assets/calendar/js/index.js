...
function Month(year, month, dates) {
  ...
  this.numberofmonth = this.date.getMonth()+1;
...
var Calendar = React.createClass({ displayName: "Calendar",
  ...
  render: function () {
    ...
    return (
      ...
      React.createElement("span", {href:"#aside_modal", className: "modal-trigger", id: "save_entry", onClick: this.saveEntry.bind(null, this.state.currYear, this.state.currMonthN, this.state.currDay) }, "Enregistrer")),

      React.createElement("div", { className: "entry_details" },
      React.createElement("div", null,
      
      React.createElement("div", { className: "entry_info2 first second duration" },
      React.createElement("i", { className: "fa fa-clock-o", "aria-hidden": "true", id : "all-days-icon" }),
      React.createElement("input", { className: "toggle", type: "checkbox", name: "all-day", id: "all-day" }),
      React.createElement("p", {id:"all-days-label"}, "Tout les jours"),
      React.createElement("div", { id: "not-all-day" },
      React.createElement("p", { id: "select_hour" }, "Choisir l'heure de debut"),
      React.createElement("p", { id: "hour" }, 
      React.createElement("input", { type: "number", id: "enter_hour", min: "1", max: "24" }), " h",),
      ),
      React.createElement("div", { id: "not-all-day" },
      React.createElement("p", { id: "select_hourfin" }, "Choisir l'heure de fin"),
      React.createElement("p", { id: "hourfin" }, 
      React.createElement("input", { type: "number", id: "enter_hourfin", min: "1", max: "24" }), " h",),
      ),
      React.createElement("div", { id: "not-all-day" },
      React.createElement("p", { id: "select_rdv" }, "Nombre de RDV"),
      React.createElement("p", { id: "rdv" }, 
      React.createElement("input", { type: "number", id: "enter_rdv", min: "1", max: "24" })))),
      ...
      React.createElement("p", { id: "entryDay" }, this.state.currDay, " ", this.state.dates.numberofmonth, " ", this.state.dates.year),
